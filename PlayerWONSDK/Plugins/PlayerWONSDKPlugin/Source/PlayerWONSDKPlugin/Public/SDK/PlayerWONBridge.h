...
/**
 * An actor to be placed into a level to act as the bridge between a game and the PlayerWON API
 */
UCLASS()
class PLAYERWONSDKPLUGIN_API APlayerWONBridge : public AActor
{
	GENERATED_BODY()
