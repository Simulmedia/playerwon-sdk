...
/**
 * A component attached to the PlayerWONBridge that handles telemetry data and errors
 */
UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class PLAYERWONSDKPLUGIN_API UTelemetryComponent : public UActorComponent
{
	GENERATED_BODY()
