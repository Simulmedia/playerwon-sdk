...
set UnrealAutoBuilder="D:\Epic Games\UE_5.5\Engine\Build\BatchFiles\RunUAT.bat" BuildPlugin -Plugin="D:\GitHub\playerwon-sdk\PlayerWONSDK\Plugins\PlayerWONSDKPlugin\PlayerWONSDKPlugin.uplugin"
